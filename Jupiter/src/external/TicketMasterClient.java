...
public class TicketMasterClient {
	...
	private static final String API_KEY = "bIAC4GkvuJuVc2yn3pOK4ZbsIOzsAAyZ";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		try {
			...
			String line;
			//没读完一直读 responseBody is JSONObject like string
		...
		try {
			...
			//check to see if outer layer is null or not (check from api documentation)
	...
	/**
	 * Helper methods to get the string from JSONObject
	 * why helper? since the address is inside of jsonObject needs to go deeper
	 */
	private String getAddress(JSONObject event) throws JSONException {
		if (!event.isNull("_embedded")) {
			...
			if (!embedded.isNull("venues")) {
				...
				//go thru different venues to get all addresses
